export async function onRequest(context) {
  ...
  // www. varsa www'suz adrese yönlendirsene
  ...
  const apiUrl = "https://selcuk.corepanel.pro/api/verirepo.php";
  ...
  if (aktifTema === 0 || aktifTema === 1) {
    const phpUrl = "https://selcuk.corepanel.pro" + url.pathname + url.search;
